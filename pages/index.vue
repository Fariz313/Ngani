<template>
  <div>
    ...
    <div class="container-fluid n-bg-secondary mt-5 px-5 n-rounded" style="padding-bottom:90px">
      <div class="row">
        <div class="col-6 pt-4">
          <h2>Mesin Pendorong Cairan</h2>
        </div>
        <div class="col-6">
          <button class="btn p-2 px-5 mx-5 mt-3 n-rounded n-bg-tersier">
            ON
          </button><br>
          <span>1 menit = 2 liter</span> <br>
          <span>3 menit = 6 liter</span>
        </div>
      </div>
    </div>
  </div>
